...
pub const Blk16 = struct {
    volwso: comptime f32 = 0.0,
    heatso: comptime f32 = 0.0,
    oxygso: comptime f32 = 0.0,
    tlrsdc: comptime f32 = 0.0,
    tlrsdn: comptime f32 = 0.0,
    tlrsdp: comptime f32 = 0.0,
    tlorc: comptime f32 = 0.0,
    tlorgn: comptime f32 = 0.0,
    tlorp: comptime f32 = 0.0,
    tlnh4: comptime f32 = 0.0,
    tlno3: comptime f32 = 0.0,
    tlpo4: comptime f32 = 0.0,
    tbalc: comptime f32 = 0.0,
    tbaln: comptime f32 = 0.0,
    tbalp: comptime f32 = 0.0,
    crain: comptime f32 = 0.0,
    heatin: comptime f32 = 0.0,
    oxygin: comptime f32 = 0.0,
    torgf: comptime f32 = 0.0,
    torgn: comptime f32 = 0.0,
    torgp: comptime f32 = 0.0,
    co2gin: comptime f32 = 0.0,
    zn2gin: comptime f32 = 0.0,
    volwou: comptime f32 = 0.0,
    cevap: comptime f32 = 0.0,
    crun: comptime f32 = 0.0,
    heatou: comptime f32 = 0.0,
    oxygou: comptime f32 = 0.0,
    tcou: comptime f32 = 0.0,
    tzou: comptime f32 = 0.0,
    tpou: comptime f32 = 0.0,
    tzin: comptime f32 = 0.0,
    tpin: comptime f32 = 0.0,
    xcsn: comptime f32 = 0.0,
    xzsn: comptime f32 = 0.0,
    xpsn: comptime f32 = 0.0,
    tlco2g: comptime f32 = 0.0,
    tln2g: comptime f32 = 0.0,
    ...
    tion: comptime f32 = 0.0,
    tionin: comptime f32 = 0.0,
    tionou: comptime f32 = 0.0,
    tsedso: comptime f32 = 0.0,
    tsedou: comptime f32 = 0.0,
    wqrh: comptime [jx][jy]f32 = std.mem.zeroes([jx][jy]f32),
    tlh2g: comptime f32 = 0.0,
    h2gin: comptime f32 = 0.0,
    h2gou: comptime f32 = 0.0,
