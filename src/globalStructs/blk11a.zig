...
pub const Blk11a = struct {
    ...
    tsmn: [jx][jy][jz + 1]f32, // Fortran: TSMN(0:JZ,JY,JX)
    vhcp: [jx][jy][jz + 1]f32, // Fortran: VHCP(0:JZ,JY,JX)
    volw: [jx][jy][jz + 1]f32, // Fortran: VOLW(0:JZ,JY,JX)
    voli: [jx][jy][jz + 1]f32, // Fortran: VOLI(0:JZ,JY,JX)
    volp: [jx][jy][jz + 1]f32, // Fortran: VOLP(0:JZ,JY,JX)
    volt: [jx][jy][jz + 1]f32, // Fortran: VOLT(0:JZ,JY,JX)
    volti: [jx][jy][jz + 1]f32, // Fortran: VOLTI(0:JZ,JY,JX)
    ...
    vhcm: [jx][jy][jz + 1]f32, // Fortran: VHCM(0:JZ,JY,JX)
    volwx: [jx][jy][jz + 1]f32, // Fortran: VOLWX(0:JZ,JY,JX)
    clsgl: [jx][jy][jz + 1]f32, // Fortran: CLSGL(0:JZ,JY,JX)
    olsgl: [jx][jy][jz + 1]f32, // Fortran: OLSGL(0:JZ,JY,JX)
    cqsgl: [jx][jy][jz + 1]f32, // Fortran: CQSGL(0:JZ,JY,JX)
    thetwz: [jx][jy][jz + 1]f32, // Fortran: THETWZ(0:JZ,JY,JX)
    thetiz: [jx][jy][jz + 1]f32, // Fortran: THETIZ(0:JZ,JY,JX)
