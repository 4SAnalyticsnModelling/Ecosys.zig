...
pub const Blk2a = struct {
    ...
    tmph: [jx][jy][366][24]f32, // Fortran: TMPH(24,366)
    sradh: [jx][jy][366][24]f32, // Fortran: SRADH(24,366)
    rainh: [jx][jy][366][24]f32, // Fortran: RAINH(24,366)
    windh: [jx][jy][366][24]f32, // Fortran: WINDH(24,366)
    dwpht: [jx][jy][366][24]f32, // Fortran: DWPTH(24,366)
    xradh: [jx][jy][366][24]f32, // Fortran: XRADH(24,366)
    fert: [jx][jy][366][20]f32, // Fortran: FERT(20,366,JY,JX)
    dwpt: [jx][jy][366][2]f32, // Fortran: DWPT(2,366)
    ...
    tmpx: [jx][jy][366]f32, // Fortran: TMPX(366)
    tmpn: [jx][jy][366]f32, // Fortran: TMPN(366)
    srad: [jx][jy][366]f32, // Fortran: SRAD(366)
    rain: [jx][jy][366]f32, // Fortran: RAIN(366)
    wind: [jx][jy][366]f32, // Fortran: WIND(366)
