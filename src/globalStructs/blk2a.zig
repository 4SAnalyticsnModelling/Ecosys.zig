...
pub const Blk2a = struct {
    ...
    preca: comptime [jx][jy]f32 = std.mem.zeroes([jx][jy]f32),
    ...
    scos: comptime f32 = 0.0,
    sazi: comptime f32 = 0.0,
    tysin: comptime f32 = 0.0,
